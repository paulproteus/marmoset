...
public class PasswordDialog extends Dialog {
	...
	private String message = "Enter DirectoryID username and password";
	private String title = "Enter DirectoryID username and password";
	...
	protected void validateInput() {
		...
		// XXX This is Maryland-specific since clas accounts start csXXXXXX
		if (usernameText.getText().matches("cs\\d\\d\\d\\d\\d\\d")) {
			errorMessage = "You need to enter your DirectoryID, not your cvs class account";
		}
