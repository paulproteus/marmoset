...
public class ExecutableTestCaseTest extends TestCase {
    ...
    public void testSimpleScriptProperties() throws IOException {
        ...
        check(tt, TestType.PUBLIC, InputKind.STRING,  "True True", ExpectedKind.STRING, "True",
                "python main.py");
    }
    ...
    public void testComplicatedScriptProperties(String testProps) throws IOException {
        ...
        check(p1, TestType.PUBLIC, InputKind.FILE, "p1.in", ExpectedKind.FILE, "p1.out",
                "python p1.py");
        ExecutableTestCase p2 = cases.get("p2");
        check(p2, TestType.PUBLIC, InputKind.FILE, "p2.in", ExpectedKind.FILE, "p2.out",
                "python p2.py");
        ExecutableTestCase r1 = cases.get("r1");
        check(r1, TestType.RELEASE, InputKind.FILE, "r1.in",
                ExpectedKind.REFERENCE_IMPL,  null, "python2.7 r1.py", "python2.7 r1-instructor.py");
        ExecutableTestCase r2 = cases.get("r2");
        check(r1, TestType.RELEASE, InputKind.STRING, "input for r2",
                ExpectedKind.REFERENCE_IMPL,  null, "python2.7 r2.py", "python2.7 r2-instructor.py");
    }
  ...
  private void check(ExecutableTestCase testCase,
      ...
      if (outputKind == ExpectedKind.REFERENCE_IMPL) {
