...
public class SyncCourse extends GradeServerInterfaceServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (String courseId : courseIds.split(",")) {
				ImportCourse.importStudents(response.getWriter(),
						course.getSemester(), course,
						Integer.parseInt(courseId), false, gradesConn, conn);
