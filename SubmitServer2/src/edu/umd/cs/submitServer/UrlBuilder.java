...
/** Builder class for creating complex urls. Can also URL encode them for use as a GET parameter.
 *
 * @author rwsims
 * 
 */
public class UrlBuilder {
	...
	/**
	 * Create a new UrlBuilder based on the servlet request. The url will be initialized with the
	 * scheme, port and server name of the request, and the first path element will be the requests's
	 * context path.
	 * 
	 * @param req
	 */
	public UrlBuilder(HttpServletRequest req) {
		...
		pathElements.add(req.getContextPath());
	}
	...
	public String toString() {
	    ...
	    builder.append(String.format("%s://%s%s",
          ...
          host,
          path));
	    System.out.printf("URLBuilder: %s %d%n", scheme, port);
		} else
