...
<body>
    ...
    <form action="${createCourseLink}" method="post" name="createCourseForm">
        <table class="form">
            <tr>
                <th colspan="2">Create new course</th>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">Description <br>(can be empty):
                </td>
                <td class="input"><textarea cols="40" rows="6" name="description"></textarea></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="input"><input name="download" type="checkbox" checked /></td>
            </tr>
            <tr class="submit">
