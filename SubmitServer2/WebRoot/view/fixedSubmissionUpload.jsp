...
<html>
  <head>
   ...
   <p>The uploaded zip file violates the Zip specification (WinZip is known to generate such files).
   The Submit server has tried to automatically fix the zip file you uploaded, but you should
